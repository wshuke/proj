...
INSERT INTO `dev_states` VALUES (1,'运行'),(2,'故障'),(3,'停运');
...
INSERT INTO `dev_types` VALUES (1,'变压器',NULL),(2,'光伏逆变器',NULL),(3,'开关设备',NULL),(4,'负载',NULL),(5,'电能质量',NULL);
...
INSERT INTO `devices` VALUES (1,'NEPCC的变压器','[{\"额定电压\":380,\"u\":\"V\"},{\"额定电流\":20,\"u\":\"A\"}]',1,2,1,'NEPCC -1F 001',1,'2018-10-26 13:51:36'),(2,'旧的光伏逆变器','[{\"额定电压\":220,\"u\":\"V\"},{\"额定电流\":20,\"u\":\"A\"}]',2,3,3,'搬到了雨花区',1,'2018-10-26 14:56:15'),(3,'天心区的变压器','[{\"额定电压\":220,\"u\":\"V\"},{\"额定电流\":20,\"u\":\"A\"}]',1,3,2,'NEPCC 3F 301',2,'2018-10-26 14:58:37'),(4,'岳麓区的变压器','[{\"额定电压\":380,\"u\":\"V\"},{\"额定电流\":30,\"u\":\"A\"}]',1,3,1,'麓山南路1号',2,'2018-10-26 17:07:08'),(5,'新注册的断路器','[{\"额定电压\":400,\"u\":\"V\"},{\"额定电流\":50,\"u\":\"A\"}]',3,3,2,'天心区区政府',2,'2018-10-31 23:07:31');
...
CREATE TABLE `fault_log` (
  ...
  `fault_value` float NOT NULL,
  `maintenance_info` varchar(20) DEFAULT NULL,
  `fault_deal_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`fault_log_id`),
  KEY `FK_fault_dev_r` (`device_id`),
  KEY `FK_fault_fault_type_r` (`fault_type_id`),
  KEY `fault_log_deal_user_id_fk` (`fault_deal_by`),
  ...
  CONSTRAINT `fault_log_deal_user_id_fk` FOREIGN KEY (`fault_deal_by`) REFERENCES `users` (`user_id`)
...
INSERT INTO `fault_log` VALUES (1,1,1,'2018-10-26 15:00:09',1,'2018-10-26 17:00:51',0,'张三',1),(2,1,2,'2018-10-26 17:35:12',1,'2018-10-26 18:01:44',0,'李四',1),(3,3,1,'2018-10-26 17:55:13',1,'2018-10-26 19:53:46',0,'王五',1),(4,1,2,'2018-10-30 11:38:38',1,'2018-11-06 19:28:40',0,'张三',1),(10,1,2,'2018-10-30 11:41:20',0,NULL,0,NULL,NULL),(11,1,1,'2018-11-06 20:02:36',0,NULL,410.1,NULL,NULL);
...
INSERT INTO `fault_types` VALUES (1,'过压'),(2,'过流'),(3,'漏电'),(4,'过温'),(5,'电流畸变严重'),(6,'A相重载'),(7,'B相重载'),(8,'C相重载');
...
INSERT INTO `history_datas` VALUES (1,'2018-10-26 14:02:39',1,'[{\"name\":\"电压\",\"val\":220,\"unit\":\"V\"},{\"name\":\"电流\",\"val\":20,\"unit\":\"A\"}]'),(2,'2018-10-26 14:05:05',1,'[{\"name\":\"电压\",\"val\":220,\"unit\":\"V\"},{\"name\":\"电流\",\"val\":20,\"unit\":\"A\"}]'),(3,'2018-10-30 10:04:27',1,'[{\"val\":220,\"unit\":\"V\",\"name\":\"电压\"},{\"val\":20,\"unit\":\"A\",\"name\":\"电流\"}]'),(5,'2018-10-30 10:16:21',1,'[{\"val\":220,\"unit\":\"V\",\"name\":\"电压\"},{\"val\":20,\"unit\":\"A\",\"name\":\"电流\"}]'),(9,'2018-10-30 11:37:09',1,'[{\"val\":230,\"unit\":\"V\",\"name\":\"电压\"},{\"val\":16,\"unit\":\"A\",\"name\":\"电流\"}]'),(10,'2018-10-30 11:38:38',1,'[{\"val\":230,\"unit\":\"V\",\"name\":\"电压\"},{\"val\":16,\"unit\":\"A\",\"name\":\"电流\"}]'),(11,'2018-11-06 16:10:36',1,'[{\"电压\":230.2,\"u\":\"V\"}]'),(12,'2018-11-06 16:12:00',1,'[{\"电压\":230.2,\"u\":\"V\"}]'),(13,'2018-11-06 16:14:13',1,'[{\"电压\":230.2,\"u\":\"V\"}]'),(14,'2018-11-06 16:16:25',1,'[{\"电压\":230.2,\"u\":\"V\"}]'),(15,'2018-11-06 16:18:41',1,'[{\"电压\":230.2,\"u\":\"V\"}]'),(16,'2018-11-06 16:20:49',1,'[{\"电压\":230.2,\"u\":\"V\"}]'),(17,'2018-11-06 16:22:57',1,'[{\"电压\":230.2,\"u\":\"V\"}]'),(18,'2018-11-06 16:24:08',1,'[{\"电压\":230.1,\"u\":\"V\"}]'),(19,'2018-11-06 16:25:57',1,'[{\"电压\":230.4,\"u\":\"V\"}]');
...
INSERT INTO `urban_areas` VALUES (1,'岳麓区'),(2,'天心区'),(3,'雨花区'),(4,'芙蓉区'),(5,'开福区'),(6,'望城区'),(7,'长沙县');
...
INSERT INTO `user_groups` VALUES (1,'超级用户','They manage everything.'),(2,'管理员',NULL),(3,'访客',NULL);
...
INSERT INTO `users` VALUES (1,'super','站长','123456','我是SuperUser',1,10,'8888888'),(2,'nepcc307','小明','123456','我修改过信息！',3,3,'123333333'),(3,'nepcc301','小王','123456','nothing to say',3,3,'1334566454'),(4,'nepcc2018','小六','654321','oh!',3,3,'1335555'),(5,'nepcc300','老王','12345678','',3,3,'123456');
...
-- Dump completed on 2018-11-11 19:24:19
